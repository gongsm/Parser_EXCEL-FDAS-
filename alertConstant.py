...
FlightPhases = Bunch(
    ...
    inhibitBit = {
        ...
        "to1":              2,       #Take Off 1"
        "to2":              3,       #Take Off 2"
        "to3ground":        4,       #Take Off 3-ground"
        "to3climb":         5,       #Take Off 3-climb"
        "cruise":           6,       #Cruise
        "approach":         7,       #Approach
        "landing":          8,       #Landing
        "taxiin":           9,       #TaxiIn
    ...
    normalize = {
        ...
        "to 2":             "to2",
        "to3ground":        "to3ground",
        "to3-ground":       "to3ground",
        "to 3ground":       "to3ground",
        "to 3-ground":      "to3ground",
        "to3climb":         "to3climb",
        "to3-climb":        "to3climb",
        "to 3climb":        "to3climb",
        "to 3-climb":       "to3climb",
...
OPCODES = {
    '.prev':    2,  # Prev (parameter or boolean)
